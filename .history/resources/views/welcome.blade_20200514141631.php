        ...
        <section id="info">
            <div class="container">
                <div class="text">
                    ...
                    <p style="color: rgb(255, 151, 55);">What's going on?</p>
                </div>
        ...
        <footer>
            <div class="thre">
                <div class="three">
                    ...
                    Quaerat aspernatur co <br>
                    dolorum optio, fugit quae<br>
                    voluptatibus consequ <br>
                    Quaerat aspernatur con <br>
                    dolorum optio, fugit <br>
                    voluptatibus consequ <br>
                    incidunt provident?
                </div>
                <div class="three">
            ...
            <div style="widows: 100%; padding:20px; color:white;background-color:rgb(199, 199, 199);text-align:center">&copy; Library 2020</div>
        </footer>
